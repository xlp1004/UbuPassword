...
{
    [TestClass]
    public class BorrarrUsuarioGestorSinCredenciales
    {
        ...
        [TestMethod]
        public void TheBorrarrUsuarioGestorSinCredencialesTest()
        {
            driver.Navigate().GoToUrl("https://localhost:44312/BorrarUsuarioGestorWeb.aspx");
