...
{
    [TestClass]
    public class PruebaCredencialesIncorrectos
    {
        ...
        [TestMethod]
        public void ThePruebaCredencialesIncorrectosTest()
        {
            ...
            driver.FindElement(By.Id("Email_Input")).SendKeys("falso@ubu.es");
            driver.FindElement(By.Id("Password_Input")).Click();
            driver.FindElement(By.Id("Password_Input")).Clear();
            driver.FindElement(By.Id("Password_Input")).SendKeys("noexiste");
            driver.FindElement(By.Id("Button1")).Click();
            driver.FindElement(By.Id("Email_Input")).Click();
            driver.FindElement(By.Id("Email_Input")).Click();
            driver.FindElement(By.Id("Email_Input")).Click();
            driver.FindElement(By.Id("Email_Input")).Click();
            // ERROR: Caught exception [ERROR: Unsupported command [doubleClick | id=Email_Input | ]]
            driver.FindElement(By.Id("Email_Input")).Click();
            driver.FindElement(By.Id("Email_Input")).Clear();
            driver.FindElement(By.Id("Email_Input")).SendKeys("admin@ubu.es");
            driver.FindElement(By.Id("Password_Input")).Click();
            driver.FindElement(By.Id("Password_Input")).Clear();
            driver.FindElement(By.Id("Password_Input")).SendKeys("falsacontra1234");
            driver.FindElement(By.Id("Button1")).Click();
            driver.FindElement(By.Id("Email_Input")).Click();
            driver.FindElement(By.Id("Email_Input")).Click();
            driver.FindElement(By.Id("Email_Input")).Click();
